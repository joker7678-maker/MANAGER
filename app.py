...
# =========================
# CSS (sidebar scura + input bianchi con testo scuro)
# =========================
st.markdown("""
<style>
...
/* ============================
   SIDEBAR: label chiare + input bianchi testo scuro
   ============================ */
section[data-testid="stSidebar"] *{
  color: #f8fafc !important; /* default chiaro su sidebar scura */
}

/* Label/caption chiare */
...
/* BOTTONI sidebar: chiari con testo scuro */
...
/* --------- INPUT BIANCHI + TESTO SCURO (quello che ti serve) --------- */
...
/* File uploader bianco + testo scuro */
